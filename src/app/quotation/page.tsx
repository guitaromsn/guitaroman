...
import { metalScrapItems, currencies } from '@/data/metalScrapItems';
...
export default function QuotationPage() {
  ...
  // Generate document number and set valid until date on mount
  useEffect(() => {
    ...
    setFormData(prev => ({
      ...prev,
      documentNumber: `QUO-${new Date().getFullYear()}-${String(Date.now()).slice(-6)}`,
  ...
  const handleConvertToInvoice = () => {
    if (confirm('Convert this quotation to an invoice?')) {
      alert('Quotation will be converted to invoice');
      // In a real app, this would redirect to invoice page with pre-filled data
    }
  };
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-foreground-secondary">Price Quotation for Customers</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="card p-6">
            <h2 className="text-xl font-semibold text-foreground mb-4">Quotation Information</h2>
          ...
          <div className="card p-6">
            <h2 className="text-xl font-semibold text-foreground mb-4">Quote To</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Input
                ...
                value={formData.customer.commercialRegister}
                onChange={(e) => setFormData(prev => ({ 
                  ...prev, 
                  customer: { ...prev.customer, commercialRegister: e.target.value }
                }))}
              />
            </div>
            <div className="mt-4">
          ...
          <div className="card p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-foreground">Quoted Items</h2>
          ...
          {/* Totals */}
          {formData.items.length > 0 && (
            <div className="card p-6 bg-blue-900/20 border-blue-500/20">
              <h2 className="text-xl font-semibold text-foreground mb-4">Quotation Summary</h2>
              <div className="space-y-2 max-w-md ml-auto">
                ...
                <div className="border-t border-border pt-2">
                  <div className="flex justify-between text-lg font-bold">
                    ...
                    <span className="text-blue-500">﷼{totals.total.toFixed(2)}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="card p-6">
            <div className="space-y-4">
              ...
              <Textarea
                ...
                rows={2}
                placeholder="Special instructions, delivery terms, etc..."
              />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-end">
            ...
            <Button type="button" variant="secondary" onClick={handleConvertToInvoice}>
